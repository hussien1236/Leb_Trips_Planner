 ...
 return (
    ...
    -flex-col">
      ...
      <div className="-mt-10 -w-full -flex -justify-center ">
         <img src="/src/assets/laptop.png"  className="-w-full -absolute " />
         <img src="/src/assets/internalPhoto.png"  className="-w-full sm:-px-14 -px-8 lg:-pt-32 md:-pt-24 sm:-pt-16 -pt-10" />
